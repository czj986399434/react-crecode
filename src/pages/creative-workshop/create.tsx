  ...
  return (
    <Layout>
      ...
      <div className="create" ref={mainRef}>
        ...
        <div className="cards">
        <div className="lamp-box" onClick={()=>{
          setDrawerVisible((visible)=>{
           return!visible
          })
        }}>
          <div className='vertical-line'></div>
          <div className={drawerVisible?'lamp light-lamp':'lamp close-lamp'}></div>
        </div>
          <div className="html-area card">
            <TextArea
              bordered={false}
              placeholder={"html代码"}
              rows={10}
